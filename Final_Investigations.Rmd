...
lm.cv<-lm(Guess_the_Cost~French_Purchasing_Page + German_Purchasing_Page + Male + Household_Income + English_as_primary + Drink_Frequency + Cab_Preference + Purchase_Frequency + Speaks_French + Speaks_German,d)
stargazer(lm.basic,lm.cv, title= "Basic Regressions")
```
##Saturated model
```{r}
